...
//       <button onClick={completeFormStep} type="button" className="wizardbutton">
//         Next Step
//       </button>;
//     }
//   };
...
//       <h1 className="wizard-heading">Complete Your Registration</h1>
//       <div className="wizard-form">
//         <div className="px-16 py-10">
//           <form>
//             {formStep === 0 && (
//               <section>
//                 <h2 className="wizard-subheading">Personal Information</h2>
...
//                 >
//                   Thank you for your submission, you'll receive your email
//                   confirmation.
//                 </button>
//               </section>
//             )}
